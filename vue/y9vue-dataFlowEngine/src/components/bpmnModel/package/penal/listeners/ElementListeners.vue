<template>
    <div class="panel-tab__content">
        <el-table :data="elementListenersList" border size="small">
            ...
            <el-table-column align="center" label="事件类型" min-width="100px" prop="event" />
            <el-table-column
        ...
        <div class="element-drawer__button">
            <el-button :icon="Plus" type="primary" @click="openListenerForm(null)">添加监听器</el-button>
        </div>
        ...
        >
            ...
            <p class="listener-filed__title">
                <span><i class="ri-stack-line" style="vertical-align: middle"></i>注入字段：</span>
...
<script lang="ts" setup>
    ...
    async function saveListenerConfig() {
        ...
        if (!validateStatus) return; // 验证不通过直接返回
        const listenerObject = createListenerObject(listenerForm.value, false, prefix.value);
