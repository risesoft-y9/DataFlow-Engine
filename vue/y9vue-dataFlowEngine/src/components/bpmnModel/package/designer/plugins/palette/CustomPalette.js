...
import { assign } from '@/components/bpmnModel/utils/min-dash.js';
...
F.prototype.getPaletteEntries = function () {
    ...
    assign(actions, {
        ...
        //'create.exclusive-gateway': createAction('bpmn:ExclusiveGateway', 'gateway', 'bpmn-icon-gateway-none', translate('Create Gateway')),//Y9--
        ...
        // 'create.subprocess-expanded': {//子流程
        //   group: 'activity',
