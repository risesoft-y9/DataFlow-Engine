<template>
    <div class="my-process-designer">
        <div class="my-process-designer__header">
            ...
            <template v-if="!$slots['control-header']">
                <el-button-group key="file-control">
                    <el-button :type="headerButtonType" @click="$refs.refFile.click()"
                        ><i class="ri-folders-line" style="margin-right: 5px"></i>打开文件
                    </el-button>
                    <el-button :type="headerButtonType" @click="downloadProcessAsXml()"
                        ><i class="ri-download-2-line" style="margin-right: 5px"></i>下载文件
                    </el-button>
                    <el-button :type="headerButtonType" @click="previewProcessXML"
                        ><i class="ri-eye-line" style="margin-right: 5px"></i>预览
                    </el-button>
                ...
                <el-button-group key="stack-control">
                    <el-tooltip effect="light">
                        <el-button :disabled="!revocable" :type="headerButtonType" @click="processUndo()"
                            ><i class="ri-arrow-go-back-line" style="margin-right: 5px"></i>撤销
                        </el-button>
                    </el-tooltip>
                    <el-tooltip effect="light">
                        <el-button :disabled="!recoverable" :type="headerButtonType" @click="processRedo()"
                            ><i class="ri-arrow-go-forward-line" style="margin-right: 5px"></i>恢复
                        </el-button>
                    </el-tooltip>
                </el-button-group>
                <el-button-group key="right-control" style="float: right; right: 14px; position: relative">
                    <el-tooltip effect="light">
                        <el-button class="global-btn-second" @click="processRestart"
                            ><i class="ri-repeat-fill" style="margin-right: 5px"></i>清空
                        </el-button>
                    </el-tooltip>
                    <el-tooltip effect="light">
                        <el-button class="global-btn-second" @click="closeDialog"
                            ><i class="ri-close-line" style="margin-right: 5px"></i>关闭
                        </el-button>
                    </el-tooltip>
                </el-button-group>
            </template>
            <!-- 用于打开本地文件-->
            <input id="files" ref="refFile" accept=".xml" style="display: none" type="file" @change="importLocalFile" />
        </div>
        ...
        <el-dialog
            ...
            width="60%"
        >
            <Codemirror v-model:value="previewResult" :height="600" :options="cmOptions" border />
        </el-dialog>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            initBpmnModeler() {
                ...
                // 设置当前bpmnModeler到全局仓库中
                useBpmnStore().setCurrentBpmnModeler(this.bpmnModeler);
