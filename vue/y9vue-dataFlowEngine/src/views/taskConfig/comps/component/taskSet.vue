...
<template>
    ...
    <div class="btn" v-if="showBtn">
        <el-button @click="top" v-if="!taskSetForm.tableData.showTimedTasks" class="global-btn-second"
            >上一步</el-button
        >
        <el-button type="primary" v-if="taskSetForm.tableData.showSave" @click="save" class="global-btn-main"
            >保存
        </el-button>
