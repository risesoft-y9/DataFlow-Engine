<template>
    <y9Table :config="y9TableConfig" uniqueIdent="taskRealTime" :filterConfig="filterConfig"></y9Table>
</template>
...
<script lang="ts" setup>
    ...
    const y9TableConfig = ref({
        ...
        pageConfig: {
            ...
            pageSize: getStoragePageSize('taskRealTime', 5), //每页显示条目个数，支持 v-model 双向绑定
            total: 2, //总条目数
