...
public class UserController {
	...
	public Y9Result<Object> createUser(@Valid @RequestBody DataUser dataUser, BindingResult result) {
	...
	@CheckResult
	public Y9Result<Object> updateUserInfo(@Valid DataUser betaUser, BindingResult result) {
