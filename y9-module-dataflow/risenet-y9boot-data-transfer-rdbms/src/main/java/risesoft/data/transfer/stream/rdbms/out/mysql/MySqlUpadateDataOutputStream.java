...
/**
 * Update 操作的流 没有逻辑判断直接根据id修改数据 mysql 使用
 * 
 * @typeName MysqlUpadateDataOutputStream
 * @date 2023年12月21日
 * @author lb
 */
public class MySqlUpadateDataOutputStream extends RdbmsDataOutputStream {

	public MySqlUpadateDataOutputStream(Connection connection, String workSql,
